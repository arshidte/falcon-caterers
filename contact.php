...
<body style="  display: flex;
    ...
    height: 100vh;
    flex-wrap: wrap;">
<div class="row alig5n-items-center justify-content-center">
    <div>   <?php if (isset($success_message)) : ?>
        <div class="col w-100" style="color: white;"><?php echo $success_message = "Thank you, $name! Your form has been submitted successfully.;" ?></div>
    <?php endif; ?>
